...
@DataTransformFn.register_subclass("wsa_pretrain_chat_processor")
@dataclass
class WSAPretrainChatProcessorTransformFn(DataTransformFn):
    ...
    def hydrate(self, dataset: LeRobotDataset | StreamingLeRobotDataset) -> WSAPretrainChatProcessorTransformFn:
...
@DataTransformFn.register_subclass("wsa_pretrain_vqa_processor")
@dataclass
class WSAPretrainVQAProcessorTransformFn(DataTransformFn):
    """VQA processor used by WSA-Pretrain mixed robot/VQA training."""
    ...
    def _collect_images(self, data: DataDict) -> list[Image.Image]:
        ...
        if not images:
            raise ValueError("WSAPretrainVQAProcessorTransformFn requires at least one valid image.")
        return images

    def _build_user_text(self, conversation: list[dict]) -> tuple[str, str]:
        if not isinstance(conversation, list) or not conversation:
            raise ValueError("WSAPretrainVQAProcessorTransformFn requires non-empty `conversation`.")
...
@DataTransformFn.register_subclass("fast_wsa_pretrain_action_tokenizer")
@dataclass
...
@DataTransformFn.register_subclass("wsa_pretrain_extract_video_frames")
@dataclass
